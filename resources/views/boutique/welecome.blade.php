                                    ...
                                    <div class="product_wrap">
                                        <div class="product_img" style="    height: 281px;">
                                            <a href="{{ url('product/detail/', []) }}/{{$article->id}}">
                                                <img style="margin-top: 50%; transform: translateY(-50%);" src="{{url('')}}/{{explode(",", $article->images)[0]}}" alt="{{$article->libelle}}" >
                                                @if (count(explode(",", $article->images))>1)
                                                    <img style="margin-top: 50%; transform: translateY(-50%);"  class="product_hover_img" src="{{url('')}}/{{explode(",", $article->images)[1]}}" alt="{{$article->libelle}}">
                                                @else
                                                    <img style="margin-top: 50%; transform: translateY(-50%);"  class="product_hover_img" src="{{url('')}}/{{explode(",", $article->images)[0]}}" alt="{{$article->libelle}}">
                                                @endif
                                            </a>
